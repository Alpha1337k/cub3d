...
//   double planeX = 0, planeY = 0.66; //the 2d raycaster version of camera plane
 ...
 //SPRITE CASTING
    ...
    sortSprites(spriteOrder, spriteDistance, md->spritecount);
    ...
    for(int i = 0; i < md->spritecount; i++)
    {
      ...
      double invDet = 1.0 / (md->plane.x * md->dir.y - md->dir.y * md->plane.y); //required for correct matrix multiplication
      ...
      if(drawEndY >= h) drawEndY = md->res.y - 1;
